...
public class EdigeoVEC {
    ...
    private static String geoType = null;
...
//                                charsetBuffer = vecParser.line;
     ...
     */
    private List<Coordinate[]> getRelation(String id) throws IOException {
     ...
     */
    private List<Coordinate[]> getType(String id) throws IOException {
        EdigeoParser parser = new EdigeoParser(vecFile);
        String buffern1 = "";
        String type = "";
        List<Coordinate[]> geoms = new LinkedList<Coordinate[]>();
     ...
     * @return
     */
    private String getXY(String line) {
        String coord = "";
     ...
     */
    private Geometry createGeometry(List<Coordinate[]> coords, String FID) throws DataSourceException {
