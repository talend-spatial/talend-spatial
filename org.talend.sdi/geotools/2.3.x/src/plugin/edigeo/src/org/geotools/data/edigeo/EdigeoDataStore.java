...
public class EdigeoDataStore extends AbstractDataStore {
    ...
    /**
     * Checks supported Edigeo / PCI object 
     * @param obj String 
     * @return String Edigeo / PCI Object
     */
    protected String checkPciObj(String aObj) {
    ...
    /**
     * Gets a FeatureReader from a EDIGEO object
     *
    ...
    public static void main(String[] args) throws IllegalAttributeException {
        ...
        try {
            EdigeoDataStore edDS = new EdigeoDataStore("/home/mcoudert/public_html/pvs/sample_data/pvs/edigeo2/042-Bercloux/EDI0000D.THF", "SUBDSECT_id");
            String typeName = edDS.getTypeNames()[0];
            FeatureSource source = edDS.getFeatureSource(typeName);
