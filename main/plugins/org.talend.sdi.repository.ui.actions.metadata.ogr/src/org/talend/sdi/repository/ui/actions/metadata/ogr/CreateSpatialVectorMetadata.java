...
public class CreateSpatialVectorMetadata extends
	org.talend.repository.metadata.ui.actions.metadata.CreateGenericSchemaAction {

	private static final String LABEL = org.talend.sdi.repository.ui.actions.metadata.ogr.Messages
			.getString("CreateSpatialVectorMetadata.title"); //$NON-NLS-1$

	public CreateSpatialVectorMetadata() {
	...
	protected void doRun() {
		openOGRDatasourceWizard();
	}

	private void openOGRDatasourceWizard() {
		ISelection selection = getSelection();
		ImportSpatialVectorSchemaWizard wizard = new ImportSpatialVectorSchemaWizard(
		...
		wizardDialog.open();
		RepositoryManager
				.refreshCreatedNode(ERepositoryObjectType.METADATA_GENERIC_SCHEMA);
	}
