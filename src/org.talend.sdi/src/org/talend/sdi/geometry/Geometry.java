...
public class Geometry {
    ...
    public boolean equals(Object o) {
        ...
        return geometry.internalGeometry.toText().equals(internalGeometry.toText());
    }
    ...
    public Geometry buffer(double distance, int quadrantSegments, int endCapStyle) {
    	return new Geometry(internalGeometry.buffer(distance, quadrantSegments, endCapStyle));
    }
    ...
    public Geometry simplify(String type, double distanceTolerance) {
    	if (type.equals("DouglasPeuckerSimplifier"))
    		return new Geometry(
        		com.vividsolutions.jts.simplify.DouglasPeuckerSimplifier.simplify(
        				internalGeometry, 
        				distanceTolerance)
        				);
        else
    ...
    public Geometry intersection(Geometry geom) {
        return new Geometry(internalGeometry.intersection(geom.internalGeometry));
    }
    
    public Geometry symDifference(Geometry geom) {
        return new Geometry(internalGeometry.symDifference(geom.internalGeometry));
    }
